"""
Django settings for citibackend project.
...
SECRET_KEY = 'django-insecure-n%yl-b+_*j(od2qvpp**oe++m6p17--3j0_-k3gi9&es*p7!#k'
...
WSGI_APPLICATION = 'citibackend.wsgi.application'
